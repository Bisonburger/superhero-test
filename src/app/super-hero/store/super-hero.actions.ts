...
export const loadSuperHeroAction = createAction('[SuperHero] Load One', props<{heroId}>() );
export const success_loadSuperHeroAction = createAction('[SuperHero] Load One Success', props<{ hero: SuperHero }>());
